# -*- coding: utf-8 -*-
"""1000_2s_ORIGINAL.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RAbN9EJtlv4fJzs_OpsutbkFExAlKi59
...
output_raw_root = "/content/drive/MyDrive/PREPROCESSING_2s/CONV/MONO_SR_sem_trunc_mod"
csv_output_dir  = "/content/drive/MyDrive/PREPROCESSING_2s/CONV/METRICS_SR_sem_trunc_mod"
checkpoint_file = "/content/drive/MyDrive/PREPROCESSING_2s/CONV/checkpoint_SR_sem_trunc_mod.txt"
...
# ───────────── Configurações ─────────────
IN_ROOT  = "/content/drive/MyDrive/PREPROCESSING_2s/CONV/MONO_SR_sem_trunc_mod"
OUT_ROOT = "/content/drive/MyDrive/PREPROCESSING_2s/CONV/MONO_SR_sem_trunc_mod_ESPEC"
DIRS = {
...
# ───────────── 1) CONFIGURAÇÕES ───────────────────────────
INPUT_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_2s/CONV/MONO_SR_sem_trunc_mod_ESPEC/log_mel")
OUTPUT_DIR = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel")
EXT_IN     = ".png"
EXT_OUT    = ".pt"
...
# Caminho raiz
root_dir = '/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel'
...
# ───────────── 1) CONFIGURAÇÕES ───────────────────────────
SRC_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel")
DEST_DIR = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA")
MOVE_FILES = False   # False = copia; True = move (remove da origem)
...
# ───────────── CONFIGURAÇÕES ──────────────────────────────
SRC_DIR   = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA")
TRAIN_DIR = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TREINO_VALID")
TEST_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TESTE")
TRAIN_RATIO = 0.8
MOVE_FILES  = True          # False = copia, True = move
...
dirs = {
    "Treino/Validação": "/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TREINO_VALID",
    "Teste"            : "/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TESTE"
}
...
TRAIN_DIR   = Path("/content/drive/MyDrive/PREPROCESSING_2s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TREINO_VALID")
LABELS_PATH = Path("/content/drive/MyDrive/Dissertação - Mestrado/NOVA_ALT_3/PARÂMETROS/merged_params.csv")
MODEL_DIR   = Path("/content/drive/MyDrive/MODELOS COMPARATIVOS_2/logmel_SR_mod_vit_mod")
MODEL_DIR.mkdir(parents=True, exist_ok=True)
