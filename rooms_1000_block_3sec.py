# -*- coding: utf-8 -*-
"""1000_3s_ORIGINAL.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19WfV3SU_VIikjPwhYHT1FM4rwZaHl6j7
...
output_raw_root = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_SR_sem_trunc_mod"
csv_output_dir  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/METRICS_SR_sem_trunc_mod"
checkpoint_file = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/checkpoint_SR_sem_trunc_mod.txt"
...
output_raw_root  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_1R_sem_trunc"
csv_output_dir   = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/METRICS_1R_sem_trunc"
checkpoint_file  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/checkpoint_1R_sem_trunc.txt"
...
rir_speech_root  = "/content/drive/MyDrive/Dissertação - Mestrado/NOVA_ALT_3/FILT_SOM_FASE_ZERO"
rir_noise_root   = "/content/drive/MyDrive/Dissertação - Mestrado/NOVA_ALT_3/FILT_SOM_FASE_ZERO_RUIDO"
output_raw_root  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_5R_sem_trunc_mod"
csv_output_dir   = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/METRICS_5R_sem_trunc_mod"
checkpoint_file  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/checkpoint_5R_sem_trunc_mod.txt"
...
# ───────────── Configurações ─────────────
IN_ROOT  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_SR_sem_trunc_mod"
OUT_ROOT = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_SR_sem_trunc_mod_ESPEC"
DIRS = {
...
# ───────────── Configurações ─────────────
IN_ROOT  = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_1R_sem_trunc"
OUT_ROOT = "/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_1R_sem_trunc_ESPEC"
DIRS = {
    t: f"{OUT_ROOT}/{t if t != 'log-Mel' else 'log_mel'}"
    for t in ["log-Mel", "STFT", "CQT"]
}
...
# ───────────── 1) CONFIGURAÇÕES ───────────────────────────
INPUT_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_3s/CONV/MONO_SR_sem_trunc_mod_ESPEC/log_mel")
OUTPUT_DIR = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel")
EXT_IN     = ".png"
EXT_OUT    = ".pt"
...
# Caminho raiz
root_dir = '/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel'
...
# ───────────── 1) CONFIGURAÇÕES ───────────────────────────
SRC_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel")
DEST_DIR = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA")
MOVE_FILES = False   # False = copia; True = move (remove da origem)
...
# ───────────── CONFIGURAÇÕES ──────────────────────────────
SRC_DIR   = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA")
TRAIN_DIR = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TREINO_VALID")
TEST_DIR  = Path("/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TESTE")
TRAIN_RATIO = 0.8
MOVE_FILES  = True          # False = copia, True = move
...
dirs = {
    "Treino/Validação": "/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TREINO_VALID",
    "Teste"            : "/content/drive/MyDrive/PREPROCESSING_3s/TENSORES_DATASET/SR_mod/log_mel_PASTA_UNICA_TESTE"
}
